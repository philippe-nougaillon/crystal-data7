...
class ProprietaireFlowTest < ApplicationSystemTestCase
  ...
  setup do
    ...
    manufacturers_users_table = create(:tables_user, role: "Propriétaire", table: @manufacturer_table)
    ...
    devices_users_table = create(:tables_user, role: "Propriétaire", table: @device_table, user: manufacturers_users_table.user)
    ...
    device_release_date_field = create(:field, table: @device_table, datatype: "Date", row_order: 2, name: "Release Date")
    device_release_date_field_value_1 = create(:value, field: device_release_date_field, record_index: 1, data: Faker::Date.between(from: 2.days.ago, to: Date.today) )
    device_release_date_field_value_2 = create(:value, field: device_release_date_field, record_index: 2, data: Faker::Date.between(from: '2014-09-23', to: '2023-09-25'))
    @device_release_date_field_value_3 = create(:value, field: device_release_date_field, record_index: 3, data: Faker::Date.between(from: '2014-04-23', to: '2023-04-25'))

    login_propriétaire(manufacturers_users_table.user)
  end
  ...
  #   fill_in "Paramètres", with: "[#{@device_table.name}.\"#{@device_table.fields.first.name},#{@device_table.fields.last.name}\"]"
  #   click_button "Ajouter cet attribut"
  #   assert_text "Nouvel attribut ajouté."
  ...
  #   field.select "#{@device_model_name_value_3.data}, #{@device_release_date_field_value_3.data}"
  #   click_button "Enregistrer"
  #   assert_text "Données ajoutées avec succès :)"
  ...
  #   assert_text I18n.l @device_release_date_field_value_3.data.to_date
  # end
  ...
  #   @manufacturer_table = tables(:interventions)
