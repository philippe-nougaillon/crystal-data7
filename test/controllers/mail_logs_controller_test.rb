...
class MailLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mail_log" do
    assert_difference("MailLog.count") do
      post mail_logs_url, params: { mail_log: { message_id: @mail_log.message_id, subject: @mail_log.subject, to: @mail_log.to, user_id: @mail_log.user_id } }
    end
  ...
  test "should update mail_log" do
    patch mail_log_url(@mail_log), params: { mail_log: { message_id: @mail_log.message_id, subject: @mail_log.subject, to: @mail_log.to, user_id: @mail_log.user_id } }
