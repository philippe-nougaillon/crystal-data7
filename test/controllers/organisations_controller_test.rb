...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference("Organisation.count") do
      post organisations_url, params: { organisation: { nom: @organisation.nom, slug: @organisation.slug } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { nom: @organisation.nom, slug: @organisation.slug } }
