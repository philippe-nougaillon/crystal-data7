...
Field.create!([
  ...
  {name: "Référence",   table_id: 1, datatype: "Texte", items: nil, filtre: false, obligatoire: false, row_order: 2, operation: nil, slug: "bde472ba-f461-41f7-843a-52cbf0a8caf8"},
  {name: "Marque",      table_id: 1, datatype: "Texte", items: nil, filtre: true, obligatoire: false, row_order: 3, operation: nil, slug: "ab8c1c4d-27eb-461e-b304-515e3126546e"},
...
Value.create!([
  ...
  {record_index: 1, field_id: 2, data: "28b95137df", user_id: 1},
  {record_index: 1, field_id: 3, data: "Nexans", user_id: 1},
  {record_index: 1, field_id: 4, data: "RJ45", user_id: 1},
  ...
  {record_index: 1, field_id: 11, data: "Installation", user_id: 1},
  {record_index: 1, field_id: 12, data: "installer une lampe", user_id: 1},
  {record_index: 1, field_id: 13, data: "Oui", user_id: 1},
  {record_index: 1, field_id: 14, data: "1", user_id: 1},
  {record_index: 1, field_id: 15, data: "", user_id: 1},
  {record_index: 1, field_id: 16, data: "0", user_id: 1},
  {record_index: 1, field_id: 17, data: "", user_id: 1},
  {record_index: 1, field_id: 18, data: "Nouveau", user_id: 1},

  {record_index: 2, field_id: 9, data: "2023-08-14", user_id: 1},
  {record_index: 2, field_id: 10, data: "Auchan", user_id: 1},
  {record_index: 2, field_id: 11, data: "Réparation", user_id: 1},
  {record_index: 2, field_id: 12, data: "Réparer caisse n°13", user_id: 1},
  {record_index: 2, field_id: 13, data: "Non", user_id: 1},
  {record_index: 2, field_id: 14, data: "2", user_id: 1},
  {record_index: 2, field_id: 15, data: "Elle est souvent cassée cette machine, c'est la 3° fois !", user_id: 1},
  {record_index: 2, field_id: 16, data: "2", user_id: 1},
  {record_index: 2, field_id: 17, data: "48.9019196, 2.553272", user_id: 1},
  {record_index: 2, field_id: 18, data: "Confirmé", user_id: 1},
  
  {record_index: 3, field_id: 9, data: "2023-08-30", user_id: 1},
  {record_index: 3, field_id: 10, data: "Monoprix", user_id: 1},
  {record_index: 3, field_id: 11, data: "Dépose", user_id: 1},
  {record_index: 3, field_id: 12, data: "Migration réseau LAN Drive", user_id: 1},
  {record_index: 3, field_id: 13, data: "Oui", user_id: 1},
  {record_index: 3, field_id: 14, data: "3", user_id: 1},
  {record_index: 3, field_id: 15, data: "Ça m'a l'air trop compliqué !", user_id: 1},
  {record_index: 3, field_id: 16, data: "4", user_id: 1},
  {record_index: 3, field_id: 17, data: "", user_id: 1},
  {record_index: 3, field_id: 18, data: "Annulé", user_id: 1},

  {record_index: 1, field_id: 19, data: "LEBRUN", user_id: 1},
  {record_index: 1, field_id: 20, data: "Félix", user_id: 1},
  {record_index: 1, field_id: 21, data: "2023-01-01", user_id: 1},
  {record_index: 1, field_id: 22, data: "", user_id: 1},
  
  {record_index: 2, field_id: 19, data: "AUGIER", user_id: 1},
  {record_index: 2, field_id: 20, data: "Alexis", user_id: 1},
  {record_index: 2, field_id: 21, data: "2021-06-01", user_id: 1},
  {record_index: 2, field_id: 22, data: "", user_id: 1},

  {record_index: 3, field_id: 19, data: "DUPIN", user_id: 1},
  {record_index: 3, field_id: 20, data: "Michel", user_id: 1},
  {record_index: 3, field_id: 21, data: "2022-09-01", user_id: 1},
  {record_index: 3, field_id: 22, data: "", user_id: 1},

  {record_index: 1, field_id: 23, data: "2023-08-30", user_id: 1},
  {record_index: 1, field_id: 24, data: "Essence", user_id: 1},
  {record_index: 1, field_id: 25, data: "82", user_id: 1},
  {record_index: 1, field_id: 26, data: "2", user_id: 1},
  {record_index: 1, field_id: 27, data: "1", user_id: 1},
  
  {record_index: 2, field_id: 23, data: "2023-09-13", user_id: 1},
  {record_index: 2, field_id: 24, data: "Repas", user_id: 1},
  {record_index: 2, field_id: 25, data: "25", user_id: 1},
  {record_index: 2, field_id: 26, data: "2", user_id: 1},
  {record_index: 2, field_id: 27, data: "1", user_id: 1},

  {record_index: 3, field_id: 23, data: "2023-08-30", user_id: 1},
  {record_index: 3, field_id: 24, data: "Essence", user_id: 1},
  {record_index: 3, field_id: 25, data: "66", user_id: 1},
  {record_index: 3, field_id: 26, data: "1", user_id: 1},
  {record_index: 3, field_id: 27, data: "2", user_id: 1},
  
  {record_index: 4, field_id: 23, data: "2023-09-13", user_id: 1},
  {record_index: 4, field_id: 24, data: "Repas", user_id: 1},
  {record_index: 4, field_id: 25, data: "15", user_id: 1},
  {record_index: 4, field_id: 26, data: "1", user_id: 1},
  {record_index: 4, field_id: 27, data: "2", user_id: 1},
  ...
  {record_index: 6, field_id: 25, data: "50", user_id: 1},
  {record_index: 6, field_id: 26, data: "3", user_id: 1},
  {record_index: 6, field_id: 27, data: "3", user_id: 1},

  {record_index: 7, field_id: 23, data: "2023-09-13", user_id: 1},
  {record_index: 7, field_id: 24, data: "Hotel", user_id: 1},
  {record_index: 7, field_id: 25, data: "150", user_id: 1},
  {record_index: 7, field_id: 26, data: "3", user_id: 1},
  {record_index: 7, field_id: 27, data: "3", user_id: 1},
