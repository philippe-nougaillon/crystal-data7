...
Value.create!([
  ...
  {record_index: 2, field_id: 7, data: "2023-08-30"},
  {record_index: 2, field_id: 8, data: "Monoprix"},
  {record_index: 2, field_id: 9, data: "en cours"},
  {record_index: 2, field_id: 10, data: "Migration réseau LAN Drive"},
  {record_index: 2, field_id: 11, data: "Oui"},
  {record_index: 2, field_id: 12, data: "Jean"},
  {record_index: 2, field_id: 14, data: "4"},
  {record_index: 2, field_id: 13, data: "Ça m'a l'air compliqué"}
])
